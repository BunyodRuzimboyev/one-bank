...
import uz.br29.profile.util.MapperUtil;
...
public class ProfileService {
    ...
    public ProfileDetailDTO getDetail(String id) {
        ...
        ResponseEntity<List<NotificationDTO>> notificationList = notificationFeignClient.getNotificationsByPhoneNumber(entity.getPhoneNumber());
        dto.setNotificationList(notificationList.getBody());
